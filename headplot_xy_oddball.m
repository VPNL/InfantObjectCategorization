...
%                   1 -> plot channel numbers; 
%                   0 -> no labels {default 0}
...
%%%editTR June 2017 to adapt for colin27headmesh spline
%DEFAULT_MESH      = ['mheadnew.mat'];      % upper head model file (987K)
   if ~isempty(strfind(arg1,'colin'))
      DEFAULT_MESH = ['colin27headmesh.mat'];
   else
...
%[0 0 0 0 0.02 -1.58 90.8693 90.8693 90.8693] = TRmanual2017
...
%%%editTR June 2017 to adapt for grayelectrodes on spline
%plotelecopt.MarkerColor= 'k';
if ~isempty(strfind(arg1,'gray'))
    plotelecopt.MarkerColor = [.4 .4 .4]
else
