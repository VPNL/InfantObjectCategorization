...
function [p, observeddifference, effectsize, permd] = permutationTest(sample1, sample2, permutations, varargin)
...
for n = 1:permutations
    ...
    permd(n) = computeCohen_d(randomSample1, randomSample2, 'independent');
end
